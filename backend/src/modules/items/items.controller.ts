...
export class ItemsController {
  ...
  @ApiResponse({
    ...
    description:
      'Invalid data or not enough available volume',
  })
  @ApiResponse({
    status:
  ...
  @ApiResponse({
    status:
      HttpStatus.CONFLICT,
    description:
      'An item with the same unique number already exists',
  })
  async create(
    @Body()
    createItemDto: CreateItemDto,
  ): Promise<ItemWithPhotoUrl> {
  ...
  @ApiQuery({
    ...
    required:
      false,
    description:
      'Filter search results by container ID',
  })
  @ApiQuery({
    name:
      'limit',
  ...
  @ApiResponse({
    status:
      HttpStatus.BAD_REQUEST,
    description:
      'Search query is missing or invalid',
  })
  async searchItems(
    @Query(queryValidationPipe)
    query: SearchItemQueryDto,
  ): Promise<
    PaginatedResponseDto<ItemWithPhotoUrl>
  > {
  ...
  @ApiOperation({
    summary:
      'Get total number of active items',
  })
  @ApiResponse({
    status:
      HttpStatus.OK,
    description:
      'Active items count retrieved successfully',
  })
  ...
  @ApiResponse({
    status:
      HttpStatus.BAD_REQUEST,
    description:
      'Invalid UUID or boolean format',
  })
  async findOne(
    @Param(
      'id',
  ...
  @ApiResponse({
    status:
      HttpStatus.BAD_REQUEST,
    description:
      'Invalid data, UUID or insufficient container volume',
  })
  @ApiResponse({
    status:
      HttpStatus.NOT_FOUND,
    description:
      'Item or container not found',
  })
  @ApiResponse({
    status:
      HttpStatus.CONFLICT,
  ...
  async remove(
    ...
    await this.itemsService.softDelete(
      id,
    );
  }
  ...
  @ApiResponse({
    status:
      HttpStatus.BAD_REQUEST,
    description:
      'Invalid UUID or item must be soft-deleted first',
  })
  async permanentDelete(
    ...
    await this.itemsService.permanentDelete(
      id,
    );
  }
}