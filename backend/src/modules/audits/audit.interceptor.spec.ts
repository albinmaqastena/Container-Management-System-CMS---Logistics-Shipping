...
describe('AuditInterceptor', () => {
  ...
  it.each([
    ['POST', '/v1/files/upload', AuditAction.FILE_UPLOAD],
    ['DELETE', '/v1/files/items/photo.jpg', AuditAction.FILE_DELETE],
    ['PUT', '/v1/items/item-id/restore', AuditAction.ITEM_RESTORE],
    ['DELETE', '/v1/containers/container-id/permanent', AuditAction.CONTAINER_PERMANENT_DELETE],
  ])('should detect %s %s as %s', async (method, url, expectedAction) => {
    reflector.getAllAndOverride.mockReturnValue(undefined);
